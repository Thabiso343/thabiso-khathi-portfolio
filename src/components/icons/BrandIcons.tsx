...
/**
 * Lucide's icon set dropped brand marks, so GitHub and LinkedIn are hand-drawn
 * here as minimal single-path SVGs to match the stroke-icon sizing used
 * elsewhere (Lucide) via a shared `size` prop.
 */
